...
public class Account extends AbstractModel {
    ...
    public void withdraw(BigDecimal amount){
        ...
        ModelEvent me = new ModelEvent(ModelEvent.EventKind.BalanceUpdate, getBalance(), AgentStatus.NA);
        notifyChanged(me);
    }
    ...
    public void deposit(BigDecimal amount){
        ...
        ModelEvent me = new ModelEvent(ModelEvent.EventKind.BalanceUpdate, this.balance, AgentStatus.NA);
        notifyChanged(me);
    }
