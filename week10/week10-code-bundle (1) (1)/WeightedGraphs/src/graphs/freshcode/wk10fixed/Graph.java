...
public class Graph {
	...
	public Vector<Edge> readWeightedFromFile(String fInName) throws IOException {
		// Reads list of edges from a file, one pair of integers per line, one double representing edge weight
		BufferedReader fIn = new BufferedReader(
							 new FileReader(fInName));
		String s;
		Vector<Edge> eList = new Vector<Edge>();
	...
	public static void main(String[] args) {
		...
		try {
			eList = g.readWeightedFromFile("/home/madras/teaching/17comp225/tutes/wk10/graph-weighted2.txt");
